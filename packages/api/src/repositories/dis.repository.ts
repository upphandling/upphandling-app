...
> {
  ...
  public readonly tenders: HasManyRepositoryFactory<Tender, typeof Dis.prototype.id>;

  constructor(
    @inject('datasources.db') dataSource: DbDataSource, @repository.getter('ParticipationRepository') protected participationRepositoryGetter: Getter<ParticipationRepository>, @repository.getter('CompanyRepository') protected companyRepositoryGetter: Getter<CompanyRepository>, @repository.getter('TenderRepository') protected tenderRepositoryGetter: Getter<TenderRepository>,
  ) {
